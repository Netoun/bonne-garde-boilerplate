...
const organizations = [{ id: "1", name: "Mon Organisation" }];
            ...
            render={
              ...
              >
                ...
                <div className="grid flex-1 text-left leading-tight">
                  ...
                  <span className="truncate text-[11px] text-muted-foreground">Organisation</span>
                </div>
          ...
          >
            ...
            <DropdownMenuGroup className="p-1">
              ...
              >
                ...
                <span className="text-sm text-muted-foreground">Créer une organisation</span>
              </DropdownMenuItem>
            </DropdownMenuGroup>
          </DropdownMenuContent>
        </DropdownMenu>
