  ...
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-background">
      ...
      <div className="relative hidden lg:flex p-8 bg-background">
        <div className="flex-1 relative flex flex-col items-center justify-center bg-gradient-to-br from-primary via-background to-secondary/50 overflow-hidden rounded-2xl"
          style={{
